 ...
 *  string TEXT,
 *  comment TEXT
 * ) -- removed semicolons, otherwise following sql fails. Add semicolons if uncommented. 
 */
...
/*
 * ADODB LOGSQL Table needed by ADODB
 * We create it here because there may not be sufficent permissions
