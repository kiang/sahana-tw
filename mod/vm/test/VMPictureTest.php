...
class VMPictureTest extends PHPUnit_Framework_TestCase {
    ...
    public function testVMPicture() {
        ...
        $expected = array($this->fixture->image_data, $this->fixture->thumb_data, $this->fixture->p_uuid, $this->fixture->width, $this->fixture->height, $this->fixture->thumb_width, $this->fixture->thumb_height, $this->fixture->type, $this->fixture->name);
