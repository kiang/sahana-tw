...
shn_form_fopen('project&vm_action=process_add');
	shn_form_fsopen(_('Project Information'));
		shn_form_text(_('Project name'), "name", '', array('req'=>true, 'value'=>$info['name']));
		...
		if(!isset($hidden['proj_id']))
			shn_form_select($managers,_('Project manager'), 'manager', '', array('req' => true));
	shn_form_fsclose();

	shn_form_fsopen(_('Project location'));
