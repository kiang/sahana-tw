...
/*
$Id: nusoap.php,v 1.12.2.2 2007/11/21 07:21:59 priyanga Exp $
...
* @version  $Id: nusoap.php,v 1.12.2.2 2007/11/21 07:21:59 priyanga Exp $
* @access   public
*/
class nusoap_base {
	/**
	 ...
	 * @access private
	 */
	var $revision = '$Revision: 1.12.2.2 $';
    /**
...
class soap_server extends nusoap_base {
	...
	*/
	function invoke_method() {
		...
		if(shn_soap_ws_authenticate()==true){

		}else{
                        $this->fault('Client', "HTTP/1.0 401 web service request is Unauthorized, please provide the credentials");
			return false;
		}
